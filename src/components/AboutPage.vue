...
.langs.show svg:nth-child(1) {
  transition-delay: 0.1s;
}
.langs.show svg:nth-child(2) {
  transition-delay: 0.2s;
}
.langs.show svg:nth-child(3) {
  transition-delay: 0.3s;
}
.langs.show svg:nth-child(4) {
  transition-delay: 0.4s;
}
.langs.show svg:nth-child(5) {
  transition-delay: 0.5s;
}
.langs.show svg:nth-child(6) {
